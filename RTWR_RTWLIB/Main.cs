...
namespace RTWR_RTWLIB
{
    class Main : Logger
    {
          ...
          PictureBox pic_map, bool chk_unitinfo, bool chk_prefs)
        {
            ...
            pic_map.Image = sm.CreateCompleteMap((M2DS)files[FileNames.descr_strat], (Descr_Region)files[FileNames.descr_regions], (SM_Factions)files[FileNames.descr_sm_faction]);
